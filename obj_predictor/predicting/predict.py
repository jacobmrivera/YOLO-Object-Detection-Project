...
def predicts_to_txt(preds, output_file, width, height):
    # Write to the file
...
def predict_video(model_path, input_vid, output_dir, conf=0.5, save_annot=False, save_frames=False, save_yolo_vid=True, save_drawn_frames=False, normalize_annot=True):
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            if save_annot:
                ...
                predicts_to_txt(predicted_bb, txt_path, width, height)
